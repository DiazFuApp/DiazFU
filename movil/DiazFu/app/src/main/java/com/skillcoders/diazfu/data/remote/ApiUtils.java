...
public class ApiUtils {
    ...
    public static final String BASE_URL = "http://diazfuwebapi.azurewebsites.net/api/";
    //public static final String BASE_URL = "http://192.168.1.79:8081/api/";
    ...
    public static GruposHistoricoRest getGruposHistoricoRest() {
        return RetrofitClient.getClient(BASE_URL).create(GruposHistoricoRest.class);
    }
    ...
    public static IntegrantesGruposHistoricoRest getIntegrantesGruposHistoricoRest() {
        return RetrofitClient.getClient(BASE_URL).create(IntegrantesGruposHistoricoRest.class);
    }
    ...
    public static DocumentosRest getDocumentosRest() {
        return RetrofitClient.getClient(BASE_URL).create(DocumentosRest.class);
    }
}
