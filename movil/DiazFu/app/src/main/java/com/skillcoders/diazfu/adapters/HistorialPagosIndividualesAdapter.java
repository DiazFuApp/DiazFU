 ...
 */
public class HistorialPagosIndividualesAdapter extends RecyclerView.Adapter<HistorialPagosIndividualesAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            txtPlazos = (TextView) itemView.findViewById(R.id.item_plazo_historial_pago_individual);
            txtMonto = (TextView) itemView.findViewById(R.id.item_monto_historial_pago_individual);
            txtFechaProgramada = (TextView) itemView.findViewById(R.id.item_fecha_programada_historial_pago_individual);
            txtEstatus = (TextView) itemView.findViewById(R.id.item_estatus_historial_pago_individual);
            btnDetalle = (Button) itemView.findViewById(R.id.item_btn_detalle_historial_plazo_pago_individual);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_historial_pagos_individuales, parent, false);
