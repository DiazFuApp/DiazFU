...
public class SampleActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mClient = new MobileServiceClient(
                    "https://diazfuapp.azurewebsites.net",
            ...
            mAdapter = new SampleAdapter(this, R.layout.row_list_to_do);
            ListView listViewToDo = (ListView) findViewById(R.id.lvLista);
    ...
    public void agregar(View view) {
        ...
        item.setNombre(mtxtNombre.getText().toString());
        item.setEstatus(1);
        ...
        AsyncTask<Void, Void, Void> task = new AsyncTask<Void, Void, Void>(){
            ...
            protected Void doInBackground(Void... params) {
                try {
                    final Sample entity = addItemInTable(item);
    ...
    private List<Sample> refreshItemsFromMobileServiceTable() throws ExecutionException, InterruptedException {
        return mSampleTable.where().field("Estatus").
                eq(val(1)).execute().get();
    }
        ...
        AsyncTask<Void, Void, Void> task = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    tableDefinition.put("Estatus", ColumnDataType.Integer);

                    localStore.defineTable("Sample", tableDefinition);
