<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="DiazFu.Modules.Administracion.Clientes.Listado" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphContenido" runat="server">
    <div class="jumbotron mt-4">
        <h1 class="h1-responsive">Clientes</h1>
        <p class="lead">
            Crea, edita o elimina los clientes disponibles en la aplicación.
        </p>
        <hr class="my-2">
        <div class="col-12 p-0">
            ...
            <asp:GridView ID="gvClientes" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true"
                ...
                data-show-export="true" data-toolbar="#toolbar" OnRowDataBound="gvClientes_RowDataBound">
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-Width="40" HeaderText="Editar">
                        <ItemTemplate>
                            <a href='<%# "/Modules/Administracion/Clientes/Captura.aspx?id=" + Eval("Id") %>' class="btn btn-primary">Editar
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <div class="col-12 p-0 text-right">
            <a href="Captura.aspx" class="btn btn-default">Crear Cliente</a>
        </div>
    </div>
