<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Captura.aspx.cs" Inherits="DiazFu.Modules.Prestamos.PrestamosIndividuales.Captura" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenido" runat="server">
    <%--DATOS DEL PRESTAMO--%>
    <div class="jumbotron mt-4" id="jtDatosPrestamo" runat="server">
        <h1 class="h1-responsive">Préstamo Individual</h1>
        <p class="lead">
            Ingresa la información del préstamo del cliente para su autorización.
        </p>
        <hr class="my-2">
        <div class="col-12 p-0">
            ...
            <div class="row">
                <div class="col">
                    <asp:DropDownList CssClass="form-control" ID="ddl_Cliente" runat="server" required AutoPostBack="true" OnSelectedIndexChanged="ddl_Cliente_SelectedIndexChanged"></asp:DropDownList>
                </div>
            </div>
    ...
    <div class="jumbotron mt-4" id="jtDocumentos" runat="server">
        ...
        <p class="lead">
            Valida los documentos del cliente para este préstamo.
        </p>
        <hr class="my-2">
        <div class="col-12 p-0">
            <asp:Repeater ID="r_Documentos" runat="server" OnItemDataBound="r_Documentos_ItemDataBound">
                <ItemTemplate>
                    <div class="col-12 p-0 mb-5">
                        <h3 class="h3-responsive"><%# Eval("Nombre") %></h3>
                        <%--DOCUMENTOS--%>
    ...
    <div class="jumbotron mt-4" id="jtAutorizacion" runat="server" visible="false">
        ...
        <div class="col-12 p-0">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="md-form">
                        <asp:TextBox ID="tb_Interes" runat="server" CssClass="form-control" required Text="10%"></asp:TextBox>
                        <label for="tb_Interes" class="">Interés</label>
                    </div>
                </div>
            </div>
            <%--PLAZOS--%>
