<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="DiazFu.Modules.Prestamos.PrestamosGrupales.Listado" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenido" runat="server">
    <div class="jumbotron mt-4">
        <h1 class="h1-responsive">Préstamos Grupales</h1>
        <p class="lead">
            Crea y monitorea los préstamos grupales disponibles en la aplicación.
        </p>
        <hr class="my-2">
            ...
            <asp:GridView ID="gvPrestamos" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-Width="40" HeaderText="Pagar">
                        <ItemTemplate>
                            <a id="aPagar" runat="server" href='<%# "/Modules/Prestamos/PrestamosGrupales/Pagos.aspx?id=" + Eval("Id") %>' class="btn btn-primary" visible="false">Pagar
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <div class="col-12 p-0 text-right">
            <a href="Captura.aspx" class="btn btn-default">Solicitar Préstamo Grupal</a>
        </div>
    </div>
