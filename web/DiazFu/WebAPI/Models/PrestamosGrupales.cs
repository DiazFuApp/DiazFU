...
namespace WebAPI.Models
{
    public class PrestamosGrupales
    {
        ...
        /// </summary>
        /// <returns>Lista con todos los préstamos grupales activos.</returns>
        public List<PrestamosGrupales> ConsultarTodo()
        {
            List<PrestamosGrupales> Prestamos = new List<PrestamosGrupales>();
            PrestamosGrupales Prestamo = new PrestamosGrupales();
            using (DataSet Consulta = Prestamo.EjecutarSP(3))
            {
                foreach (DataRow Fila in Consulta.Tables[0].Rows)
                {
                    PrestamosGrupales obj = new PrestamosGrupales
                    {
        ...
        /// </summary>
        /// <returns>Lista con todos los préstamos grupales activos.</returns>
        public List<PrestamosGrupales> Consultar()
        {
            List<PrestamosGrupales> Prestamos = new List<PrestamosGrupales>();
            PrestamosGrupales Prestamo = new PrestamosGrupales();
            using (DataSet Consulta = Prestamo.EjecutarSP(3))
